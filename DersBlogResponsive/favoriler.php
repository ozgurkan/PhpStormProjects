...
<nav class="ok-sidenav ok-collapse ok-white ok-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
    ...
    <a href="hakkimda.php" onclick="ok_close()" class="ok-padding"><i class="fa fa-id-card fa-fw ok-margin-right"></i>HAKKIMDA</a>
    <a href="favoriler.php" onclick="ok_close()" class="ok-padding ok-text-teal"><i class="fa fa-star fa-fw ok-margin-right"></i>FAVORİLER</a>
        ...
        <div class="ok-row-padding">
            <div class="ok-col s12  m6 ok-container ok-margin-bottom">
                ...
                <div class="ok-container ok-white ">
                    <img src="images/10.jpg" alt="Norway" style="width:100%" class="ok-hover-opacity">
                    ...
                    <button class="button" style="background-color: #e74c3c;vertical-align:middle" type="submit" ><span>Siteye Git</span></button>
                </div>
            </div>

            <div class="ok-col s12  m6 ok-container ok-margin-bottom">
                <div class="ok-container ok-white">
                    <img src="images/11.jpg" alt="Norway" style="width:100%" class="ok-hover-opacity">
                    <h2 style="text-align:center"><b>Lorem Ipsum</b></h2>
                    <p style="text-indent: 15px;">
                        Praesent tincidunt sed tellus ut rutrum. Sed vitae justo condimentum, porta lectus vitae, ultricies congue gravida diam non fringilla.
                        Praesent tincidunt sed tellus ut rutrum. Sed vitae justo condimentum, porta lectus vitae, ultricies congue gravida diam non fringilla.
