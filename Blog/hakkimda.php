...
<div id="container">
              ...
              <section>
                  <div id="slider">
                      ...
                      <div id="slider_buton" style="background-image: url('images/icons/slider_buton_bg.png');">
                          <div id="onceki">
                    ...
                    <h1>Hakkkımda Sayfası</h1>

                  <div id="sosyal_medya">
                      <ul>
                          <li><a href="#"><em class="fa fa-facebook fa-3x"></em><h3>Facebook</h3></a></li>
                          <li><a href="#"><em class="fa fa-twitter fa-3x"></em><h3>Twitter</h3></a></li>
                          <li><a href="#"><em class="fa fa-google-plus fa-3x"></em><h3>Google Plus</h3></a></li>
                          <li><a href="#"><em class="fa fa-youtube fa-3x"></em><h3>YouTube</h3></a></li>
                      </ul>
                  </div>
                  ...
                  <div id="sag_alan">
                      <div id="arama">
                          <form style="">
                              <input type="text" class="textbox" placeholder="Kelime...">
                              <input type="submit" class="button"  value="ARA">
                          </form>
                      </div>

                      <div id="kategori" style="width: 250px;height:auto;margin-top: 10px">
                        <h1 style="text-align: center;font-size:30px;font-weight: bold">Kategoriler</h1>
                          <ul style="background-color: white">
                              <li style="border: 1px solid gray;width: 250px;height: 30px;font-size: 25px;font-weight: bold;padding: 10px 0px"><a href="#"> ~ Genel</a></li>
                              <li style="border: 1px solid gray;width: 250px;height: 30px;font-size: 25px;font-weight: bold;padding: 10px 0px"><a href="#"> ~ PHP</a></li>
                              <li style="border: 1px solid gray;width: 250px;height: 30px;font-size: 25px;font-weight: bold;padding: 10px 0px"><a href="#"> ~ ASP.NET</a></li>
                              <li style="border: 1px solid gray;width: 250px;height: 30px;font-size: 25px;font-weight: bold;padding: 10px 0px"><a href="#"> ~ VİSUAL BASİC</a></li>
                              <li style="border: 1px solid gray;width: 250px;height: 30px;font-size: 25px;font-weight: bold;padding: 10px 0px"><a href="#"> ~ HTML & CSS</a></li>
                              <li style="border: 1px solid gray;width: 250px;height: 30px;font-size: 25px;font-weight: bold;padding: 10px 0px"><a href="#"> ~ JAVA</a></li>
                              <li style="border: 1px solid gray;width: 250px;height: 30px;font-size: 25px;font-weight: bold;padding: 10px 0px"><a href="#"> ~ C#</a></li>
                              <li style="border: 1px solid gray;width: 250px;height: 30px;font-size: 25px;font-weight: bold;padding: 10px 0px"><a href="#"> ~ JAVASCRİPT</a></li>
                              <li style="border: 1px solid gray;width: 250px;height: 30px;font-size: 25px;font-weight: bold;padding: 10px 0px"><a href="#"> ~ MSSQL</a></li>
                              <li style="border: 1px solid gray;width: 250px;height: 30px;font-size: 25px;font-weight: bold;padding: 10px 0px"><a href="#"> ~ MYSQL</a></li>
                          </ul>
                      </div>
                      ...
                      <div is="populer_konular" style="margin-top: 20px;width: 250px;height: 500px;background-color: yellow">
                          <h1 style="text-align: center;font-size:30px;font-weight: bold">Popüler Konular</h1>
                      </div>
                  </div>
